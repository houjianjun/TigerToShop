...
<link href="/static/style/personal.css" rel="stylesheet" type="text/css">
<link href="/static/style/systyle.css" rel="stylesheet" type="text/css">
					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userinfo">
								<div class="m-baseinfo">
									<a href="information.html"> <img
										src="/static/images/getAvatar.do.jpg">
							...
							<div class="m-userproperty">
								...
								<p class="m-bonus">
									<a href="bonus.html"> <i><img src="/static/images/bonus.png" /></i>
										<span class="m-title">红包</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-coupon">
									<a href="coupon.html"> <i><img
											src="/static/images/coupon.png" /></i> <span class="m-title">优惠券</span>
										<em class="m-num">2</em>
									</a>
								</p>
								<p class="m-bill">
									<a href="bill.html"> <i><img src="/static/images/wallet.png" /></i>
										<span class="m-title">钱包</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img src="/static/images/day-to.png" /></i> <span
										class="m-title">签到有礼</span>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img src="/static/images/72h.png" /></i> <span
						...
						<div class="m-order">
							...
							<ul>
								<li><a href="order.html"><i><img
											src="/static/images/pay.png" /></i><span>待付款</span></a></li>
								<li><a href="order.html"><i><img
											src="/static/images/send.png" /></i><span>待发货<em class="m-num">1</em></span></a></li>
								<li><a href="order.html"><i><img
											src="/static/images/receive.png" /></i><span>待收货</span></a></li>
								<li><a href="order.html"><i><img
											src="/static/images/comment.png" /></i><span>待评价<em
											class="m-num">3</em></span></a></li>
								<li><a href="change.html"><i><img
											src="/static/images/refund.png" /></i><span>退换货</span></a></li>
							</ul>
						</div>
						<!--九宫格-->
						<div class="user-patternIcon">
							...
							<ul>
								...
								<a href="collection.html"><li class="am-u-sm-4"><i
										...
										<p>我的收藏</p></li></a>
								<a href="/static/home/home.html"><li class="am-u-sm-4"><i
						...
						<div class="m-logistics">
							...
							<div class="s-content">
								<ul class="lg-list">
									<li class="lg-item">
										<div class="item-info">
											<a href="#"> <img src="/static/images/xz.jpg"
												alt="">
											</a>
										</div>
										<div class="lg-info">
									...
									<div class="s-item">
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="/static/images/item_pic.jpg"
